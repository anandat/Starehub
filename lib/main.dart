                    ...
                    if (widget.model.hasSeenIntro == null) {
                      ...
                      return MaterialApp(
                          ...
                          theme: GalleryOptions.of(context).locale == Locale('ar')
                              ? GalleryThemeData.lightArabicThemeData(context, widget.model.blocks.theme, widget.model.blocks.typography).copyWith(
                            platform: GalleryOptions.of(context).platform,
                          ) : GalleryThemeData.lightThemeData(context, widget.model.blocks.theme, widget.model.blocks.typography).copyWith(
                            platform: GalleryOptions.of(context).platform,
                          ),
                          darkTheme: GalleryOptions.of(context).locale == Locale('ar')
                              ? GalleryThemeData.darkArabicThemeData.copyWith(
                            platform: GalleryOptions.of(context).platform,
                          ) : GalleryThemeData.darkThemeData(context, widget.model.blocks.theme, widget.model.blocks.typography).copyWith(
                            platform: GalleryOptions.of(context).platform,
                          ),
                          home: App()
                      );
                      ...
                      return MaterialApp(
                        debugShowCheckedModeBanner: false,
                        theme: ThemeData(primaryColor: Colors.deepOrange, appBarTheme: AppBarTheme(elevation: 0)),
                        darkTheme: ThemeData(primaryColor: Colors.deepOrange, appBarTheme: AppBarTheme(elevation: 0)),
                        home: Material(
                            child: Scaffold(
