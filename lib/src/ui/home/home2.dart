...
import '../../ui/blocks/banner_top_slider.dart';
import '../../ui/blocks/top_icons.dart';
import '../../ui/blocks/top_static_icons.dart';
  ...
  List<Widget> buildLisOfBlocks(BlocksModel snapshot) {
    ...
    for (var i = 0; i < snapshot.blocks.length; i++) {
      ...
      if ((snapshot.blocks[i].blockType == 'product_block' || snapshot.blocks[i].blockType == 'flash_sale_block') &&
        ...
        list.add(ProductScroll(products: snapshot.blocks[i].products, context: context, title: snapshot.localeText.sale, viewAllTitle: snapshot.localeText.viewAll, filter: filter));
