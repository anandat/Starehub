                    ...
                    child: ClipPath(
                      ...
                      child: Container(
                        ...
                        LinearGradient(
                                ...
                                colors: [
                                  Color(0xFFFF6E40),
                                  Color(0xFFFF6E40).withOpacity(.8),
                                ]
                            ) : LinearGradient(
                               begin: Alignment.centerLeft, end: Alignment.centerRight,
                               colors: [
                      ...
                      child: ListView(
                        children: [
                          ...
                          RoundedLoadingButton(
                              color: Theme.of(context).brightness == Brightness.light ? Color(0xFFFF6E40) : Color(0xffbdbdbd),
                            elevation: 3,
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                        ...
                                        style: Theme.of(context).textTheme.subtitle1.copyWith(color: Color(0xFFFF6E40),fontWeight: FontWeight.w500)),
                                  ),
                                ],
                              )),
                          FlatButton(
