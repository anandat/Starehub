...
class LocaleText {
  ...
  LocaleText({
    ...
    this.searchYourPlace,
    this.weAreNotInYourArea,
    this.changeYourLocation,
    this.tapToSelectThisLocation,
    this.nearbyPlaces,
    this.becomeVendor,
    this.notifications
  });
  ...
  factory LocaleText.fromJson(Map<String, dynamic> json) => LocaleText(
    ...
    becomeVendor: json["becomeVendor"] == null ?"Become a vendor": json["becomeVendor"],
...
class Settings {
  ...
  bool isRtl;
  String distance;
  bool enableHomeTabBar;
  bool showBottomTabLabels;
  bool listingAddToCart;
  bool isMultivendor;
  String home;
  List<String> labels;
  bool footerAddToCartButton;
  String accountChatType;
  String facebookPage;
  ...
  Settings({
    ...
    this.isRtl,
    this.distance,
    this.enableHomeTabBar,
    this.showBottomTabLabels,
    this.listingAddToCart,
    this.isMultivendor,
    this.home,
    this.labels,
    this.footerAddToCartButton,
    this.accountChatType,
    this.facebookPage,
  });
  ...
  factory Settings.fromJson(Map<String, dynamic> json) => Settings(
    ...
    enableHomeTabBar: _nullOrEmptyOrFalse(json["enableHomeTabBar"]) != false ? true : false,
    showBottomTabLabels: _nullOrEmptyOrFalse(json["showBottomTabLabels"]) != false ? true : false,
    listingAddToCart: _nullOrEmptyOrFalse(json["listingAddToCart"]) == true ? false : true,
    isMultivendor: _nullOrEmptyOrFalse(json["isMultivendor"]) ? false : true,
    home: _nullOrEmptyOrFalse(json["home"]) ? 'Home1' : json["home"],
    labels: json["labels"] == null ? [] : List<String>.from(json["labels"].map((x) => x)),
    footerAddToCartButton: _nullOrEmptyOrFalse(json["footerAddToCartButton"]) ? false : true,
    accountChatType: json["accountChatType"] == null ? null : json["accountChatType"],
    facebookPage: json["facebookPage"] == null ? null : json["facebookPage"],
  );
}
...
class AppTheme {
  ...
  factory AppTheme.fromJson(Map<String, dynamic> json) => AppTheme(
    primarySwatch: json["primary_swatch"] == null ? '#FF4500' : json["primary_swatch"],
    primaryColor: json["primary_color"] == null ? '#FFFFFF' : json["primary_color"],
    accentColor: json["accent_color"] == null ? '#FF581A' : json["accent_color"],
